...
public class SecurityHeadersBuilder
{
    ...
    /// </summary>
    public SecurityHeadersBuilder AddStrictTransportSecurityMaxAgeIncludeSubDomains()
    {
        _policy.SetHeaders[StrictTransportSecurityConstants.Header] =
    ...
    public SecurityHeadersBuilder AddContentSecurity()
    {
        _policy.SetHeaders[ContentSecurityConstants.Header] =
            ContentSecurityConstants.Default;
        return this;
    }

    public SecurityHeadersBuilder AddRefererPolicy()
    {
        _policy.SetHeaders[RefererPolicyConstants.Header] = RefererPolicyConstants.Default;
        return this;
    }

    public SecurityHeadersBuilder AddFeaturePolicy()
    {
        _policy.SetHeaders[FeaturePolicyContants.Header] = FeaturePolicyContants.Default;
        return this;
    }
